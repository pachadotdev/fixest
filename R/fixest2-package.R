...
#'
#' The package \pkg{fixest2} provides a family of functions to perform estimations
...
#' * To get started, look at the [introduction](https://cran.r-project.org/package=fixest2/vignettes/fixest2_walkthrough.html).
#'
...
#' non-linear in parameters right hand sides. Finally [`fepois`][fixest2::feglm]
#' and [`fenegbin`][fixest2::femlm] are shorthands to estimate Poisson and Negative
#' Binomial models.
...
#' [Multiple estimations](https://cran.r-project.org/package=fixest2/vignettes/multiple_estimations.html)
#' * Easy and flexible clustering of standard-errors. By using the arguments `vcov`
#' and `ssc` (see [`summary.fixest2`]). To have a sense of how the standard errors are computed,
#' see the vignette [On standard-errors](https://lrberge.github.io/fixest2/articles/standard_errors.html).
...
#' This vignette details how to customize the Latex tables: [Exporting estimation tables](https://lrberge.github.io/fixest2/articles/exporting_tables.html).
