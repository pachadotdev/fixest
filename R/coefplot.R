...
#'
#' @seealso
#' See [`setFixest_coefplot`] to set the default values of `coefplot`, and the estimation functions: e.g. [`feols`], [`fepois`][fixest2::feglm], [`feglm`], [`fenegbin`][fixest2::femlm].
#'
...
coefplot <- function(object, ..., style = NULL, sd, ci_low, ci_high, x, x.shift = 0, horiz = FALSE,
  ...
  info <- coefplot_prms(
    object = object, ..., sd = sd, ci_low = ci_low, ci_high = ci_high,
