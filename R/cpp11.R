...
cpp_fixed_cost_gaussian <- function(n_i, n_cells, index_i, index_j, order, invTableCluster_vector, dum_vector) {
  .Call(`_fixest2_cpp_fixed_cost_gaussian`, n_i, n_cells, index_i, index_j, order, invTableCluster_vector, dum_vector)
}
...
cpp_derivconv_seq_gnl <- function(iterMax, diffMax, n_vars, nb_cluster_all, ll_d2, jacob_vector, deriv_init_vector, dum_vector) {
  .Call(`_fixest2_cpp_derivconv_seq_gnl`, iterMax, diffMax, n_vars, nb_cluster_all, ll_d2, jacob_vector, deriv_init_vector, dum_vector)
}
...
cpp_derivconv_seq_2 <- function(iterMax, diffMax, n_vars, nb_cluster_all, n_cells, index_i, index_j, order, ll_d2, jacob_vector, deriv_init_vector, dum_vector) {
  .Call(`_fixest2_cpp_derivconv_seq_2`, iterMax, diffMax, n_vars, nb_cluster_all, n_cells, index_i, index_j, order, ll_d2, jacob_vector, deriv_init_vector, dum_vector)
}
...
cpp_conv_acc_gnl <- function(family, iterMax, diffMax, diffMax_NR, theta, nb_cluster_all, lhs, mu_init, dum_vector, tableCluster_vector, sum_y_vector, cumtable_vector, obsCluster_vector, nthreads) {
  .Call(`_fixest2_cpp_conv_acc_gnl`, family, iterMax, diffMax, diffMax_NR, theta, nb_cluster_all, lhs, mu_init, dum_vector, tableCluster_vector, sum_y_vector, cumtable_vector, obsCluster_vector, nthreads)
}
...
cpp_conv_seq_gnl <- function(family, iterMax, diffMax, diffMax_NR, theta, nb_cluster_all, lhs, mu_init, dum_vector, tableCluster_vector, sum_y_vector, cumtable_vector, obsCluster_vector, nthreads) {
  .Call(`_fixest2_cpp_conv_seq_gnl`, family, iterMax, diffMax, diffMax_NR, theta, nb_cluster_all, lhs, mu_init, dum_vector, tableCluster_vector, sum_y_vector, cumtable_vector, obsCluster_vector, nthreads)
}
...
cpp_conv_seq_poi_2 <- function(n_i, n_j, n_cells, index_i, index_j, dum_vector, sum_y_vector, iterMax, diffMax, exp_mu_in, order) {
  .Call(`_fixest2_cpp_conv_seq_poi_2`, n_i, n_j, n_cells, index_i, index_j, dum_vector, sum_y_vector, iterMax, diffMax, exp_mu_in, order)
}
...
cpp_conv_seq_gau_2 <- function(n_i, n_j, n_cells, r_mat_row, r_mat_col, r_mat_value_Ab, r_mat_value_Ba, dum_vector, lhs, invTableCluster_vector, iterMax, diffMax, mu_in) {
  .Call(`_fixest2_cpp_conv_seq_gau_2`, n_i, n_j, n_cells, r_mat_row, r_mat_col, r_mat_value_Ab, r_mat_value_Ba, dum_vector, lhs, invTableCluster_vector, iterMax, diffMax, mu_in)
}
...
cpppar_crossprod <- function(X, w, nthreads) {
  .Call(`_fixest2_cpppar_crossprod`, X, w, nthreads)
}
...
cpp_tapply_vsum <- function(Q, x, dum) {
  .Call(`_fixest2_cpp_tapply_vsum`, Q, x, dum)
}
...
cpppar_exp <- function(x, nthreads) {
  .Call(`_fixest2_cpppar_exp`, x, nthreads)
}

cpppar_log <- function(x, nthreads) {
  .Call(`_fixest2_cpppar_log`, x, nthreads)
}

cpppar_log_a_exp <- function(nthreads, a, mu, exp_mu) {
  .Call(`_fixest2_cpppar_log_a_exp`, nthreads, a, mu, exp_mu)
}
...
cpppar_lgamma <- function(x, nthreads) {
  .Call(`_fixest2_cpppar_lgamma`, x, nthreads)
}

cpppar_digamma <- function(x, nthreads) {
  .Call(`_fixest2_cpppar_digamma`, x, nthreads)
}

cpppar_trigamma <- function(x, nthreads) {
  .Call(`_fixest2_cpppar_trigamma`, x, nthreads)
}
...
cpppar_xwy <- function(X, y, w, nthreads) {
  .Call(`_fixest2_cpppar_xwy`, X, y, w, nthreads)
}

cpppar_xbeta <- function(X, beta, nthreads) {
  .Call(`_fixest2_cpppar_xbeta`, X, beta, nthreads)
}
