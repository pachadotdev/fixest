...
cpppar_crossprod_ <- function(X, w, nthreads) {
...
cpppar_log_ <- function(x, nthreads) {
  .Call(`_fixest2_cpppar_log_`, x, nthreads)
}

cpppar_log_a_exp_ <- function(nthreads, a, mu, exp_mu) {
...
cpppar_digamma_ <- function(x, nthreads) {
  .Call(`_fixest2_cpppar_digamma_`, x, nthreads)
}

cpppar_trigamma_ <- function(x, nthreads) {
...
cpppar_xbeta_ <- function(X, beta, nthreads) {
...
cpp_newey_west_panel_ <- function(S, w, unit, G, time, n_time, nthreads) {
  .Call(`_fixest2_cpp_newey_west_panel_`, S, w, unit, G, time, n_time, nthreads)
}

cpp_driscoll_kraay_ <- function(S, w, time, n_time, nthreads) {
