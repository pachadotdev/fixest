...
cpp_demean <- function(y, X_raw, r_weights, iterMax, diffMax, r_nb_id_Q, fe_id_list, table_id_I, slope_flag_Q, slope_vars_list, r_init, nthreads, algo_extraProj, algo_iter_warmup, algo_iter_projAfterAcc, algo_iter_grandAcc, save_fixef) {
...
cpp_log_a_exp <- function(a, mu, exp_mu, nthreads) {
  .Call(`_fixest_cpp_log_a_exp`, a, mu, exp_mu, nthreads)
}

cpp_lgamma <- function(x, nthreads) {
...
cpp_cond_means <- function(mat_vars, treat, nthreads) {
