...
[[cpp11::register]] list cpp_iv_products_(doubles_matrix<> X, SEXP y, doubles_matrix<> Z, SEXP u, doubles w, int nthreads = 1)
{
...
[[cpp11::register]] list cpp_iv_product_completion_(doubles_matrix<> XtX, doubles Xty, doubles_matrix<> X, doubles y, doubles_matrix<> U, doubles w, int nthreads = 1)
{
    // We compute the following
    // - (UX)'(UX)
    // - (UX)'y
...
[[cpp11::register]] doubles cpp_iv_resid_(doubles resid_2nd, doubles coef, SEXP resid_1st, bool is_int, int nthreads = 1)
{
