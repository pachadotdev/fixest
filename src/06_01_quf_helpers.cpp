...
void quf_double(int n, int *x_uf, void *px, std::vector<double> &x_unik,
  ...
  std::vector<unsigned long long> x_ulong(is_string ? 1 : n), x_tmp(n);
...
void quf_int_gnl(int n, int *x_uf, void *px, std::vector<double> &x_unik,
                 int x_min, bool is_double) {
  ...
  std::vector<int> x_uint(n), x_tmp(n);
...
void quf_int(int n, int *x_uf, void *px, std::vector<double> &x_unik, int x_min,
...
[[cpp11::register]] list cpp_quf_gnl_(SEXP x) {
  ...
  bool IS_STR = false;
  std::vector<unsigned long long> x_ull;
