...
```{r}
# Warning: [fenegbin] Optimization failed at iteration 1. Reason: Error : Invalid input type, expected 'integer' actual 'double'
...
tab = etable(gravity_pois, gravity_ols, vcov = "twoway", headers = c("Poisson", "Gaussian"))
