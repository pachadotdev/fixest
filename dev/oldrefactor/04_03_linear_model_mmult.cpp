...
void mp_sparse_XtX(writable::doubles_matrix<> &XtX, const vector<int> &n_j,
                   const vector<int> &start_j, const vector<int> &all_i,
                   const vector<double> &x, const doubles_matrix<> &X,
                   int nthreads) {
  int K = X.ncol();
...
void mp_sparse_Xty(writable::doubles &Xty, const vector<int> &start_j,
                   const vector<int> &all_i, const vector<double> &x,
...
void mp_sparse_ZXtZX(writable::doubles_matrix<> &ZXtZX,
                     const doubles_matrix<> &XtX, const vector<int> &n_j,
                     const vector<int> &start_j, const vector<int> &all_i,
                     const vector<double> &x, const doubles_matrix<> &X,
...
void mp_sparse_ZXtu(writable::doubles &ZXtu, const vector<int> &start_j,
                    const vector<int> &all_i, const vector<double> &x,
