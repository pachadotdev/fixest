...
// [[Rcpp::export]]
int cpp_get_nb_threads() { return omp_get_max_threads(); }
...
// [[Rcpp::export]]
NumericVector cpp_logit_devresids(NumericVector y, NumericVector mu,
                                  NumericVector wt, int nthreads) {
...
// [[Rcpp::export]]
NumericVector cpp_xwy(NumericMatrix X, NumericVector y, NumericVector w,
                      int nthreads) {
...
// [[Rcpp::export]]
List cpp_cond_means(NumericMatrix mat_vars, IntegerVector treat,
                    int nthreads = 1) {
