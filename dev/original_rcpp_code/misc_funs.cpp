...
// [[Rcpp::export]]
NumericVector cpp_partialDerivative_other(int iterMax, int Q, int N,
                                          double epsDeriv, NumericVector ll_d2,
                                          NumericVector dx_dother,
                                          NumericVector init,
                                          IntegerMatrix dumMat,
  ...
  NumericVector clusterDeriv(
      sum_cases); // the derivatives per cluster, stacked in one vector
...
// [[Rcpp::export]]
int cpp_constant_dum(int k, NumericVector x, IntegerVector dum,
                     bool only_0 = false) {
...
// [[Rcpp::export]]
IntegerVector cpp_check_nested(SEXP fe_list, SEXP cluster_list,
                               IntegerVector fe_sizes, int n) {
...
// [[Rcpp::export]]
List cpp_cut(NumericVector x_sorted, NumericVector cut_points,
             IntegerVector is_included) {
