...
// [[Rcpp::export]]
SEXP compute_cluster_coef_r(int family, int nb_coef, double theta,
                            double diffMax_NR, SEXP r_mu, SEXP r_lhs,
                            SEXP r_sum_y, SEXP r_dum, SEXP r_obsCluster,
                            SEXP r_table, SEXP r_cumtable, int nthreads) {
  ...
  computeClusterCoef_single(family, n_obs, nb_coef, theta, diffMax_NR, pcoef,
                            mu, lhs, sum_y, dum, obsCluster, table, cumtable,
                            nthreads);
